 ...
 * DaoImpl.java
 */
package com.flyhaze.framework.dao.impl;
...
import com.flyhaze.framework.query.QueryUtils;
 ...
 * @see com.flyhaze.framework.dao.IDao<E>
...
public abstract class DaoImpl<E extends BaseIdEntity<E>> extends BasisDaoImpl<E, String> implements IDao<E> {
    ...
    @Override
    public <C> C findUnipueResultByHQL(String hql, Map<String, Object> param, Class<C> cls) throws ApplicationException {
        Session session = getSession();

        Query<C> query = session.createQuery(hql, cls);
