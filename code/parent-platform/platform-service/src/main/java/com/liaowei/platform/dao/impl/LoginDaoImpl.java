...
import com.liaowei.platform.entity.SysAuthMenu;
import com.liaowei.platform.entity.SysMenu;
import com.liaowei.platform.entity.SysRoleAuth;
 ...
 * @see com.liaowei.platform.dao.ILoginDao
 * @since jdk1.8
 */
@Repository("loginDao")
    ...
    public List<SysMenu> findSysMenusByUserId(String userId, String siteCode, boolean isAdmin) {
        ...
        if (!menuList.isEmpty()) {
            ...
            for (SysMenu sysMenu : menuList) {
                ...
                list.add(new SysMenu(sysMenu.getId(), sysMenu.getMenuUrl(), sysMenu.getMenuType(), sysMenu.getSiteCode(),
